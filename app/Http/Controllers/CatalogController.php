...
class CatalogController extends Controller
{
    ...
    //Controlador que mostra l'index
    public function index(){
        return view('catalog.index', ['peliculas' => $this->arrayPeliculas]);
    }

    //Controlador que mostra una pel·lícula
    public function show($id){
        return view('catalog.show', ['pelicula' => $this->arrayPeliculas[$id], 'id' => $id]);
	}

    //Controlador per crear una pel·lícula
    public function create (){
        return view('catalog.create');     
    }

    //Controlador per editar una pel·lícula
    public function edit ($id){
        return view('catalog.edit', ['pelicula' => $this->arrayPeliculas[$id], 'id' => $id]);
    }

	//Controlador per mostrar les dades d'una pel·lícula nova
	public function new(Request $request) {
        $pelicula = $request->all();
		$pelicula['rented']=false;
		return view('catalog.new', ['pelicula' => $pelicula]);
	}
}
